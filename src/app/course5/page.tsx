...
export default function CoursePage() {
  ...
  const [videoUrl, setVideoUrl] = useState<string>("/videos/5.mp4")
    ...
    <div suppressHydrationWarning className="h-screen bg-white text-gray-800">
        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-semibold">
              Course Name: <span className="text-blue-600">个人工作流分享</span>
            </h1>
          </div>
      ...
      <div className="max-w-6xl mx-auto p-4 grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-4 h-[calc(100vh-80px)]">
        <div className="space-y-4 overflow-y-auto">
          ...
          <AllSummary timestamp="20250211110540" />
        </div>

        {/* Right Panel */}
        <div className="bg-gray-100 rounded-3xl h-full overflow-hidden">
          {currentView === "summary" && <SummaryView timestamp="20250211110540" />}
          {currentView === "practice" && (
            <PracticeView 
              timestamp="20250211110540" 
