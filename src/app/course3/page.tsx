...
export default function CoursePage() {
  ...
  const [videoUrl, setVideoUrl] = useState<string>("/videos/3.mp4")
  ...
  console.log('传递给 SummaryView 的 timestamp:', timestamp || "20250211012739 ");

  return (
    <div suppressHydrationWarning className="h-screen bg-white text-gray-800">
      {/* Header */}
        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-semibold">
              Course Name: <span className="text-blue-600">三分钟认识SCI</span>
            </h1>
          </div>
      ...
      <div className="max-w-6xl mx-auto p-4 grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-4 h-[calc(100vh-80px)]">
        <div className="space-y-4 overflow-y-auto">
          ...
          <AllSummary timestamp="20250211012739" />
        </div>
